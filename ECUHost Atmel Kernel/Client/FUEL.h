...
#define FUEL_nPeakOutput                EH_IO_TMR10
#define FUEL_nHoldOutput                EH_IO_TMR9
...
EXTERN TEPMAPI_ttEventTime 	FUEL_tStartPeakFraction;	
EXTERN TEPMAPI_ttEventTime 	FUEL_tTimePeak;	
EXTERN GPM6_ttPulseUs 			FUEL_tTimePeakUs;	

...
//ASAM mode=readvalue name="CTS Sensor Voltage" type=uint32 offset=0 min=0 max=5 m=0.001 b=0 units="V" format=5.3 help="CTS Sensor Voltage"
EXTERN GPM6_ttTempC CTS_tTempCRaw;
EXTERN GPM6_ttTempC CTS_tTempCFiltered;
//ASAM mode=readvalue name="Coolant Temperature" type=uint32 offset=0 min=0 max=200 m=0.001 b=0 units="degrees C" format=5.3 help="Coolant Temperature"

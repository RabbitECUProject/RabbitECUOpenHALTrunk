...
void USERDIAG_vStart(puint32 const pu32Arg)
{
	...
	{		
		...
		{	
			stPortConfigCB.enPortMode = IOAPI_enPortComms;
			stPortConfigCB.u32BaudRateHz = USERDIAG_nCAN2Frequency;
			stPortConfigCB.enVIOResource = EH_VIO_CAN2;
			stPortConfigCB.stPinConfig.uPinInfo.stCANPinInfo.enRXPin = EH_IO_CAN2R;
			stPortConfigCB.stPinConfig.uPinInfo.stCANPinInfo.enTXPin = EH_IO_CAN2T;	
